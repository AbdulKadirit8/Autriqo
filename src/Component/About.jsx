                            ...
                            <div className="about-item">
                                ...
                                <div className="row g-4">
                                    ...
                                    <div className="col-sm-5 d-flex align-items-center">
                                        <Link to='/contact' className="btn btn-primary rounded py-3 px-5">Contact Us</Link>
                                    </div>
                                    <div className="col-sm-7">
                                        <div className="d-flex align-items-center">
                                            <img src="images/FounderImage.png" className="img-fluid rounded-circle border border-4 border-secondary" style={{ width: "100px", height: "100px" }} alt="Image" />
                                            <div className="ms-4">
                                                <h4>Abdul Kadir</h4>
