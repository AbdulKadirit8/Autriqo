                        ...
                        {CarStateData.filter(x => x.status).map((item => {
                            return <SwiperSlide key={item.id}>
                                <div className="categories-item p-4">
                                    <div className="categories-item-inner">
                                        <div className="categories-img rounded-top">
                                            <img src={`${import.meta.env.VITE_APP_IMAGE_SERVER}${item.pic[3]}`} className="img-fluid w-100 rounded-top" alt="" />
                                        </div>
                                        <div className="categories-content rounded-bottom p-4">
                                            <h4>{item.name}</h4>
                                            {/* <div className="categories-review mb-4">
                                            ...
                                            <div className="mb-4">
                                                <h4 className="bg-white text-primary rounded-pill py-2 px-4 mb-0">&#8377;{item.finalRentAmount}/Day</h4>
                                            </div>
                                            <div className="row gy-2 gx-0 text-center mb-4">
                                                <div className="col-6 border-end border-white">
                                                    <i className="fa fa-users text-dark"></i> <span className="text-body ms-1">{item.seatingCapacity} Seat</span>
                                                </div>
                                                <div className="col-6 border-end border-white">
                                                    <i className="fa fa-car text-dark"></i> <span className="text-body ms-1">{item.drivingMode}</span>
                                                </div>
                                                <div className="col-6">
                                                    <i className="fa fa-gas-pump text-dark"></i> <span className="text-body ms-1">{item.type}</span>
                                                </div>
                                                <div className="col-6 border-end border-white">
                                                    <i className="fa fa-car text-dark"></i> <span className="text-body ms-1">{item.registrationNumber}</span>
                                                </div>
                                            </div>
                                            <a href="#" className="btn btn-primary rounded-pill d-flex justify-content-center py-3">Book Now</a>
                                        </div>
